...
<div
  class="container d-flex flex-column justify-content-center align-items-center accueil-welcome-box"
>

<!-- Bloc Image Texte Welcome -->
  <div
    class="accueil-text-welcome accueil-text-box d-flex justify-content-center mt-2 mb-4 flex-wrap"
  >
...
<div
  class="container d-flex btns-accueil align-items-center justify-content-center flex-wrap"
>
  <div class="card form-log-reg" style="width: 24rem">
    ...
    >
      ...
      <a href="#" class="btn btn-custom-color btn-accueil-connect"
        >Se connecter</a
      >
    </div>
  </div>
  ...
  <div
    class="card form-log-reg justify-content-center align-items-center"
    style="width: 24rem"
  >
    ...
    >
      ...
      <a href="#" class="btn btn-custom-color btn-accueil-register"
        >Créer un compte</a
      >
    </div>
  </div>
