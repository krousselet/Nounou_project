...
<head>
  ...
  <meta name="description" content="Simplifiez la garde de vos enfants avec Nounou Projet X ! Gérez les gardes, horaires, disponibilités et la facturation. Pour les Parents et les Nounous !">
  <title>Nounou Projet X</title>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end bg-secondary" aria-labelledby="accountDropdown">
              <?php if ($session->isLogin()) { ?>
                <li><a class="dropdown-item btn_profil text-light" href="#">Profile</a></li>
