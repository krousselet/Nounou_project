  ...
  init: function () {
    document.querySelector(".btn_d_addChild").addEventListener("click", () => {
      let form = panda.util.newelem("form", {
        className:
          "form_d_addChild form-log-reg form-ajout-enfant mt-2 card col-10 col-sm-8 col-md-6 col-lg-4 d-flex flex-column justify-content-center align-items-center",
      });
      form.appendChild(
        panda.util.newelem("h2", {
